	...
	$.extend($.fn, {
		multiSelect: function(o, callback) {
			...
			$(this).each( function() {
				...
				html += '<div class="multiSelectOptions" style="position: absolute; z-index: 99999; visibility: hidden;width:70px;font-size:15px"></div>';
				$(select).after(html);
				...
				multiSelect.find("span").css("width", '70px');
