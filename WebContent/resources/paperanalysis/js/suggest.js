...
(function(NS) {
    ...
    Lang.augmentObject(NS.Suggest.prototype, {
        ...
        _initContainer: function() {
            ...
            var divsh = document.getElementById("search_cf");
            divsh.insertBefore(container,divsh.childNodes[0]);  
        },
        ...
        _setContainerRegion: function() {
            ...
            var left = r.left, w = r.right - left - 3;  // 减去border的2px 
            // ie8兼容模式
            ...
            this.container.style.top = (r.bottom + prefix) + "px";
        ...
        _submitForm: function() {
            ...
            if (this.config.submitFormOnClickSelect) {
            	...
            	if (typeof key.trim == "undefined"){
            		String.prototype.trim = function(){
            	    	return this.replace(/(^\s*)|(\s*$)/g, "");
            		};
            	}
        		if (key.trim().length <= 0){
        			document.getElementById("q").value = "请输入查询条件";
        			return;
        		}
        		if (key.trim() == "请输入查询条件"){
