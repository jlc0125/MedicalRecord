...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${initParam.resources}/resources/recipe/css/recipe.css">
	...
	<script type="text/javascript" src="${initParam.resources}/resources/recipe/js/graph_recipe.js"></script>
...
<body>
	...
	<div class="bg_heise">
		<div class="imgFrame">
			<a href="recipehome"><img src="${initParam.resources}/resources/recipe/image/r_122.png" /></a>
		</div>
