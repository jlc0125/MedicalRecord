...
<head>
    ...
    <script type="text/javascript">
            ...
            $.get(url, function(data, status){
                try{
                    ...
                    data.forEach(function(each){
                        ...
                        var html = "<li class='" + label + "'><a href='symptom?name=" + encodeURI(encodeURI(each.name)) + "'>" + each.name +"</a></li>";
        ...
        function search(query, option){
            var url = "symptom/data?q=" + query + "&option=" + option;
            $.get(url, function(data, status){
                ...
                var html = "";
                data.forEach(function(each){
                    html += "<tr><td><a href='symptom?name=" + encodeURI(encodeURI(each.name)) + "'>" + each.name +"</a></td><td>" + each.pinci + "</td></tr>";
                });
...
<body>
    ...
    <div class="col-md-2 right-list">
        ...
        <ul class="nav nav-tabs right-list-nav">
            <li role="presentation" class="active"><a>常见疾病</a></li>
